...
final class ExportController extends Controller
{
    ...
    public function excel(int $projectId, Request $request): StreamedResponse
    {
        ...
        $row     = 6;
        $headerFill = new Fill();
        $headerFill->setFillType(Fill::FILL_SOLID)->getStartColor()->setRGB('3DAFA8');
    ...
    {
        // TODO: implementare export PDF (richiede dompdf o simile)
        // Per ora restituisce lo stesso Excel rinominato
